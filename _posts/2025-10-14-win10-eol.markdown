...
Businesses can continue to get Windows 10 updates (paid) until 2028 through the Extended Security Updates program. This would ensure security updates until **2028** though this is an expensive route but does ensure Windows 10 to continue to be in action until at least 2028. Regardless of ESU status, **Microsoft Defender** virus definitions and **Microsoft Edge** support (this will presumably extend to Chromium support, so browsers like Google Chrome, Brave and Opera are likely to be covered too) also are planned to end in 2028.
...
My theory would be, it's down to the COVID-19 pandemic of 2020. 
...
While today isn’t the end of our journey together, it does mark the end of an era. One that oversaw the rise of a resurgent AMD, the start of ray tracing and the rise (and fall) of VR as well as the rise of AI.